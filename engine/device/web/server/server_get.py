...
class GameServerGet(GameServerBase):
    ...
    def ReadReplayFile(self, file_path: str) -> web.Response:
        ...
        return web.json_response({
            ...
            "player_names": [x.name for x in replay.players],
            "scenario": replay.campaign.name,
            "expert": replay.campaign.expert,
    ...
    def __init__(self) -> None:
        ...
        self.AddAwaitGetSecurity('/list_campaign_deck', self.list_campaign_deck)
